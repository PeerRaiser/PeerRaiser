...
abstract class Handler_Abstract extends \PeerRaiser\Core\View implements Handler_Interface {
    ...
    /**
     * @see    \PeerRaiser\Core\Logger
     * @var    int                        Level of record to handle
     */
    protected $level = \PeerRaiser\Core\Logger::DEBUG;
    ...
    */
    ...
    /**
     * @return    \PeerRaiser\Core\Logger\Formatter\Formatter_Interface    current or default formatter
     */
    ...
    protected function get_default_formatter() {
        return new \PeerRaiser\Core\Logger\Formatter\Normalizer();
    }
