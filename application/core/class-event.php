...
class Event {
    ...
    /**
     * @var    string    Who has stopped event
     */
    ...
    public function get_formatted_result() {
        ...
        switch ( $this->get_type() ) {
            ...
            case self::TYPE_JSON:
                ...
                // $debug = \PeerRaiser\Core\Setup::get_plugin_config()->get( 'debug_mode' );
                // if ( $debug && is_array( $result ) ) {
                //     $dispatcher = \PeerRaiser\Core\Event\Dispatcher::get_dispatcher();
                //     $listeners = $dispatcher->get_listeners( $this->get_name() );
                ...
                // }
                $result = \PeerRaiser\Helper\String::peerraiser_json_encode( $result );
                break;
        }
        return $result;
    }
