<form class="peerraiser-donation-form" method="post" enctype="multipart/form-data">
	...
	<section class="peerraiser-donation-amounts">
		...
		<ul class="peerraiser-donation-amount-buttons">
			<li class="default-amounts"><input type="radio" name="donation_amount" value="25" class="peerraiser-donation-button" id="button_1"><label for="button_1"><?php echo peerraiser_money_format( 25, true, false ); ?></label>
		...
		<div class="peerraiser-donation-amount-other">
			...
			<?php if ( $peerraiser['currency_position'] === 'before' ) : ?>
				<?php /* translators: 1: Currency symbol 2: Donation amount */ ?>
				<?php $field_placeholder = sprintf( __( 'Other Amount (%1$s%2$s Min)', 'peerraiser' ), $peerraiser['currency_symbol'], '10' ); ?>
			<?php else : ?>
